...
<div class="row py-3">
  <div class="col-12">
    <h2 class="fs-4" id="proposed-budget-expenditure-by-policy">歲出政事別預算表</h2>
    <table id="proposed-budget-expenditure-by-policy-table" class="table table-striped table-bordered w-100">
      <thead>
        <tr>
          <th></th>
          <th>款</th>
...
<!-- end of proposed_budget_expenditure_by_policy -->
