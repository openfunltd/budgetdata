...
$this->og_description = "中央政府預計從哪裡賺錢的分類帳";
...
<div class="content mx-2 mt-3">
  <div class="container-fluid">
    <!-- budget_proposal_income_by_sources -->
    <div class="row py-3">
      <div class="col-12">
        <table id="income-by-sources-table" class="table table-striped table-bordered w-100">
          <thead>
            <tr>
              <th></th>
              <th>款</th>
    ...
    <!-- end of budget_proposal_income_by_sources -->
  </div>
</div>
<?= $this->partial('common/footer') ?>
<script src="/static/js/budget_proposal/income_by_sources.js"></script>
